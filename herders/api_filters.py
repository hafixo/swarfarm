...
class MonsterInstanceFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = {
            ...
            'monster__name': ['exact'],
            'tags__pk': ['exact'],
            'stars': ['exact', 'gt', 'gte', 'lt', 'lte', 'in'],
            'level': ['exact', 'gt', 'gte', 'lt', 'lte', 'in'],
            'monster__com2us_id': ['exact', 'in'],
            'monster__family_id': ['exact', 'in'],
            'monster__element': ['exact', 'in'],
            'monster__natural_stars': ['exact', 'gt', 'gte', 'lt', 'lte', 'in'],
            'monster__archetype': ['exact', 'in'],
            'priority': ['exact', 'in'],
            'monster__awaken_level': ['exact', 'in'],
            'monster__leader_skill__attribute': ['exact', 'in'],
            'monster__leader_skill__area': ['exact', 'in'],
            'monster__skills__skill_effect__pk': ['exact', 'in'],
            'monster__skills__scaling_stats__pk': ['exact', 'in'],
            'effects_logic': ['exact'],
            'fodder': ['exact'],
            'in_storage': ['exact'],
